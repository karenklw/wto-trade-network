...
data <- read.csv("code/WtoData_20250209133853.csv")
...
# plot_filename <- "density_transitivity_plot.png"
...
# cluster_2011_filename <- "appendixA/clusters_2011.png"
...
#   table_filename <- paste0("appendixA/cluster_", cluster_id, "_2011.png")
...
# cluster_2022_filename <- "appendixA/clusters_2022.png"
...
#   table_filename <- paste0("appendixA/cluster_", cluster_id, "_2022.png")
#   png(table_filename, width = 500, height = 1500)
#   grid.draw(table_with_title)
#   dev.off()
# }
...
```{r, warning=F, message=F}
# construct network list for temporal ERGM models
...
# save(network_list, file = "network_list.rda")
```
...
summary(model_gdp)
# save(model_gdp, file = "model_gdp.rda")
```
...
# save(model_gdp_log, file = "model_gdp_log.rda")
```
...
# save(model_gdp_diff, file = "model_gdp_diff.rda")
```
...
summary(model_gwesp)
# save(model_gwesp, file = "model_gwesp.rda")
```
...
# save(model_gwesp_temporal, file = "model_gwesp_temporal.rda")
```